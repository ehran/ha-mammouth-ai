...
How can I assist? eteint le plafonnier du bureau Je ne trouve pas de plafonnier du bureau configuré dans Home Assistant. Veux-tu que je vérifie sous un autre nom ou domaine ? combien d'entités vois tu Il y a un total de 1567 entités dans cette instance Home Assistant. que vois tu dans le bure
